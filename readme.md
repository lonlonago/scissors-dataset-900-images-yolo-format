# Scissors dataset (900 images YOLO format

# Body

Scissors dataset (900 images, YOLO format) - Clear and complete annotations for target detection, computer vision, algorithm training, ready to use, saves time and effort.
